...
pub fn rich_text_shell_split(
    segments: &[RichTextSegment],
) -> Option<(Vec<String>, HandleRegistry)> {
...
mod tests {
    ...
    fn test_rich_text_split_text_only() {
        ...
        let (args, registry) = rich_text_shell_split(&segments).unwrap();
    ...
    fn test_rich_text_split_segment_boundary_breaks() {
        ...
        let (args, _) = rich_text_shell_split(&segments).unwrap();
