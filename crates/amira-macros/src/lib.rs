//! Procedural macros for the Amira bot framework.
...
///
/// ```rust,ignore
/// #[amira_macros::register_capability(ws_client)]
/// pub async fn ws_connect(
///     config: WsClientConfig,
///     handler: Arc<dyn ConnectionHandler>,
/// ) -> TransportResult<()> { ... }
///
/// #[amira_macros::register_capability(ws_server)]
/// pub async fn ws_listen(
///     config: WsServerConfig,
///     handler: Arc<dyn ConnectionHandler>,
/// ) -> TransportResult<()> { ... }
///
/// #[amira_macros::register_capability(http_client)]
/// pub async fn http_start_client(
///     config: HttpClientConfig,
///     handler: Arc<dyn ConnectionHandler>,
/// ) -> TransportResult<()> { ... }
///
/// #[amira_macros::register_capability(http_server)]
/// pub async fn http_listen(
///     config: HttpServerConfig,
///     handler: Arc<dyn ConnectionHandler>,
/// ) -> TransportResult<()> { ... }
///
/// #[amira_macros::register_capability(sse_client)]
...
/// static that wires the function into the capability registry in `amira-core`.
///
